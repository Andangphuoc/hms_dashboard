...
const testimonials = [
  {
    ...
    quote: 'With just 30 days of personalized nutrition guidance and consistent effort, John D. turned his goals into reality, proving that...',
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/676f9617fd73c5458e0b98f0_image.webp',
  ...
  },
  {
    ...
    quote: 'After years of trying fad diets, I was skeptical about working with a nutritionist. But John’s plan was simple, practical, and...',
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/6770c39bb48cd7674f4b5c04_Mask%20group%20(1).webp',
  ...
  },
  {
    ...
    quote: 'Mark came to me for help with meal planning and improving my fitness. Not only did I lose 20 pounds in 3 months, but I also...',
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/676f97caf8f6d5a24f8fe673_image%20(6).webp',
        ...
        <div className="testimonial-layout">
          ...
          <div className="section-head">
            <div className="section-title-block">
              ...
              <h2 className="h2 font-600">Success Stories from Our Satisfied Clients</h2>
            </div>
          </div>
            ...
            <div className="row g-4">
              {testimonials.map((testimonial, index) => (
                <div className="col-md-4" key={index}>
                  <a href={testimonial.link} className="testimonial-card d-block text-decoration-none">
