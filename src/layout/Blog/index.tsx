...
const blogPosts = [
  {
    ...
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/67601f10bdb99ed7bb6df382_67601c776fa5126b688e6b09_675d2474bf09953dd00ade8e_675d21312d9234c7634fd28d_blog-thumbnail.webp',
  ...
  },
  {
    ...
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/6760202f10470581a907551e_blog-thumbnail-2.webp',
  ...
  },
  {
    ...
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/676020b09c27483f620bb9f1_blog-thumbnail-3.webp',
  ...
  },
  {
    ...
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/676020e21e398a5363d0c19e_blog-thumbnail-4.webp',
  ...
  },
  {
    ...
    category: 'Fitness',
    date: 'August 31, 2024',
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/67602134889daf3e275aea22_blog-thumbnail-5.webp',
  ...
  },
  {
    ...
    category: 'Nutrition',
    date: 'August 28, 2024',
    image: 'https://cdn.prod.website-files.com/675bd0d0bd1b8a5d457b5df0/67602176bcb783f2847cce6b_blog-thumbnail-6.webp',
            ...
            <div className="introductory-head">
              ...
              <div className="introductory-title-block">
                <div className="introductory-title-wrap">
                  <h1 className="h1 font-berkshire">The Food & Wellness Guide</h1>
                </div>
                <div className="introductory-text-wrap">
                  <p className="text-xl">
                    At NutriZen, we offer a comprehensive range of nutrition counseling services designed to meet your unique health and wellness goals.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="blog-collection-list">
                {currentPosts.map((post, index) => (
                  <div key={index} className="blog-card">
                    <a href={post.link} className="blog-card-image-block">
                      <img
                        src={post.image}
                    ...
                    <div className="courses-card-info">
                      <div className="blog-card-diet-date-block">
                        <a href={`/blog-categories/${post.category.toLowerCase()}`} className="blog-card-category">
                          <div className="text-default">{post.category}</div>
                        </a>
                        <div className="dot"></div>
                        <div className="text-default">{post.date}</div>
                      </div>
                      <a href={post.link} className="blog-card-title-block">
